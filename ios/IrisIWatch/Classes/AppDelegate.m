...
-(void)showLocalNotification {
    ...
    notification.alertBody = @"IRIS, Account update";
...
// only valid if IrisIWatch-Info.plist specifies a protocol to handle
...
//    reply(nil);
    reply(@{@"Notification Alert":[NSString stringWithFormat:@"APP Sent"]});
}
