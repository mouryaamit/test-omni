...
//static const CGFloat kBorderImageWidthPhone = 320;
//static const CGFloat kBorderImageHeightPhone = 396;
...
//    **************** Overlay image   *************************
    ...
    if (UI_USER_INTERFACE_IDIOM() == UIUserInterfaceIdiomPhone) {
        if (screenSize.height < 481.0f) {    /*  Resolution : 320x480   */
            ...
            overlayGraphic = [[UIImageView alloc] initWithImage:[UIImage imageNamed:@"iPhone4.png"]];
        } else if(screenSize.height < 569.0f){    /*  Resolution : 320x568   */
            /*Do iPhone 5 stuff here.*/
            overlayGraphic = [[UIImageView alloc] initWithImage:[UIImage imageNamed:@"iPhone5.png"]];
        } else if(screenSize.height < 668.0f){     /*  Resolution : 375 × 667   */
            /*Do iPhone 6 stuff here.*/
            overlayGraphic = [[UIImageView alloc] initWithImage:[UIImage imageNamed:@"iPhone6.png"]];
        } else if(screenSize.height < 737.0f){     /*  Resolution : 414 × 736   */
            /*Do iPhone 6 PLUS stuff here.*/
            overlayGraphic = [[UIImageView alloc] initWithImage:[UIImage imageNamed:@"iPhone6Plus.png"]];
        }
        
    } else {
        /*Do iPad stuff here.*/
        overlayGraphic = [[UIImageView alloc] initWithImage:[UIImage imageNamed:@"iPad.png"]];
    }
    
    UIImageView *overlayGraphicView = overlayGraphic;
    ...
    [overlay addSubview:overlayGraphicView];
//    **************** Overlay image END  *************************
...
//    _topLeftGuide.frame = CGRectMake(0,
//                                     0,
...
- (void)dismissCameraPreview {
    ...
    //************  Code to Hide Toolbar after completion of taking picture. ( Toolbar was shifting to middle of screen on dismiss of camera view )
    [_captureButton removeFromSuperview];
    [_backButton removeFromSuperview];
    [_buttonPanel removeFromSuperview];
}
